...
/**
 * Componente visual que muestra el historial de registros de la bitácora.
 * Renderiza una línea de tiempo vertical con los registros ordenados.
 * 
 * @param registros - Array de registros de bitácora a mostrar.
 */
